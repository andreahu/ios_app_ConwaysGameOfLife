...
protocol GridViewDataSource {
    //AH: the gridview will only interact with outside world via this protocol.For conforming this protocol: need to have the methods(take a position and return a cellstate). Anyone who meet this protocol can be my data source
...
@IBDesignable class GridView: UIView {
    ...
    @IBInspectable var size: Int {
        get { return dataSource!.size }
        set { dataSource?.size = size }
    }
