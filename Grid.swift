...
//AH: Implement the wrap around rules
...
//AH: Provide a sequence of all positions
...
//AH: below are all Engine stuff for automating the grid with a Timer
...
//    var grid: Grid = Grid(100,100)
    var refreshRate: Double = 0.0
    var refreshTimer: Timer?
    var rows: Int
    var cols: Int
    var name: String = "new config"
    ...
    static var sharedInstance: Engine = Engine(rows:10, cols: 10)
